...
users = pd.read_csv('../../web/data/users.csv')
...
def recommend_and_store_prediction(interactions, products, product_vectors):
    ...
    recommendations_df.to_csv('../../web/data/predictions.csv', index=False, mode='a', header=not pd.io.common.file_exists('../../web/data/predictions.csv'))
